...
class SonoffZBM5_2C_Root extends SonoffBase {

    async onNodeInit({ zclNode }) {

        super.onNodeInit({ zclNode });

        this.log('ZBM5-2C-120 Gang 1 (root) init — endpoint 1');
    ...
    async onDeleted() {
        this.log("ZBM5-2C-120 Gang 1 (root) removed");
    }

}

module.exports = SonoffZBM5_2C_Root;
