...
class SonoffZBM5_3C_Root extends SonoffBase {

    async onNodeInit({ zclNode }) {

        super.onNodeInit({ zclNode });

        this.log('ZBM5-3C-120 Gang 1 (root) init — endpoint 1');
    ...
    async onDeleted() {
        this.log("ZBM5-3C-120 Gang 1 (root) removed");
    }

}

module.exports = SonoffZBM5_3C_Root;
